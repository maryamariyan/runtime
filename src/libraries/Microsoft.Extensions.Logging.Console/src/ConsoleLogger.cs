...
namespace Microsoft.Extensions.Logging.Console
{
    ...
    {
        private readonly IEnumerable<LogFormatter> _formatters;

        private readonly string _name;
        private readonly ConsoleLoggerProcessor _queueProcessor;

        // public ConsoleLogger SetLogger(LogFormatter customFormatter)
        // {
        //     ;
        // }

        internal ConsoleLogger(string name, ConsoleLoggerProcessor loggerProcessor, IEnumerable<LogFormatter> formatters)
        {
            if (name == null)
            {
