...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class OptionsBuilderValidationExtensions
    {
            ...
            where TOptions : class, new()
        {
            ...
            _ = optionsBuilder.Services.AddOptions<ValidatorOptions>()
                                       .Configure<IOptions<TOptions>>((vo, options) =>
                                       {
                                           ...
                                           _ = vo.Validators.TryAdd(typeof(TOptions), () => _ = options.Value);
                                       });
        ...
        /// <summary>
        /// Register this options instance for validation of its DataAnnotations in startup time rather then in runtime.
        /// </summary>
        /// <typeparam name="TOptions">The type of options.</typeparam>
        /// <param name="optionsBuilder">The <see cref="OptionsBuilder{TOptions}"/> to configure options instance.</param>
        /// <returns>The <see cref="OptionsBuilder{TOptions}"/> so that additional calls can be chained.</returns>
        public static OptionsBuilder<TOptions> ValidateDataAnnotationsEagerly<TOptions>(this OptionsBuilder<TOptions> optionsBuilder)
            where TOptions : class, new()
        {
            return optionsBuilder.ValidateDataAnnotations().ValidateEagerly();
        }
    }
}
